(() => {
  ...
  const translations = {
    fr: {
      ...
      pill10: "10 langues",
      navPricing: "Tarifs",
      pricingKicker: "Offre visiteur",
      pricingTeaser: "Licence 7 jours, accès sans restriction",
      pricingTitle: "Licence 7 jours — accès complet",
      pricingSubtitle: "Profitez de toutes les fonctionnalités de CityLoopQuest pendant 7 jours, sans restriction.",
      pricingPeriod: "valable 7 jours",
      pricingUnlimited: "Accès sans restriction",
      pricingFeature1: "Tous les parcours de la ville",
      pricingFeature2: "Guidage GPS, quiz, culture et contenus audio",
      pricingFeature3: "10 langues incluses",
      pricingNote: "Achat et activation dans l’app de la ville choisie (section « Lancer l’app »).",
      pricingCta: "Choisir une ville",
    ...
    en: {
      ...
      pill10: "10 languages",
      navPricing: "Pricing",
      pricingKicker: "Visitor offer",
      pricingTeaser: "7-day licence, unrestricted access",
      pricingTitle: "7-day licence — full access",
      pricingSubtitle: "Enjoy all CityLoopQuest features for 7 days with no restrictions.",
      pricingPeriod: "valid for 7 days",
      pricingUnlimited: "Unrestricted access",
      pricingFeature1: "All city routes",
      pricingFeature2: "GPS guidance, quizzes, culture and audio content",
      pricingFeature3: "10 languages included",
      pricingNote: "Purchase and activation in the app for your chosen city (Launch the app section).",
      pricingCta: "Choose a city",
...
shotCaption10: "Local dialect",
    ...
    nl: {
      ...
      pill10: "10 talen",
      navPricing: "Tarieven",
      pricingKicker: "Bezoekersaanbod",
      pricingTeaser: "7-dagen licentie, onbeperkte toegang",
      pricingTitle: "7-dagen licentie — volledige toegang",
      pricingSubtitle: "Geniet 7 dagen lang van alle CityLoopQuest-functies, zonder beperkingen.",
      pricingPeriod: "geldig 7 dagen",
      pricingUnlimited: "Onbeperkte toegang",
      pricingFeature1: "Alle routes in de stad",
      pricingFeature2: "GPS-begeleiding, quizzen, cultuur en audio",
      pricingFeature3: "10 talen inbegrepen",
      pricingNote: "Aankoop en activatie in de app van de gekozen stad (sectie App starten).",
      pricingCta: "Kies een stad",
...
shotCaption10: "Lokaal dialect",
    ...
    de: {
      ...
      pill10: "10 Sprachen",
      navPricing: "Preise",
      pricingKicker: "Besucherangebot",
      pricingTeaser: "7-Tage-Lizenz, uneingeschränkter Zugang",
      pricingTitle: "7-Tage-Lizenz — voller Zugang",
      pricingSubtitle: "Nutzen Sie 7 Tage lang alle Funktionen von CityLoopQuest ohne Einschränkungen.",
      pricingPeriod: "7 Tage gültig",
      pricingUnlimited: "Uneingeschränkter Zugang",
      pricingFeature1: "Alle Stadtrouten",
      pricingFeature2: "GPS-Führung, Quiz, Kultur und Audioinhalte",
      pricingFeature3: "10 Sprachen inklusive",
      pricingNote: "Kauf und Aktivierung in der App der gewählten Stadt (Bereich App starten).",
      pricingCta: "Stadt wählen",
...
shotCaption10: "Lokaler Dialekt",
    ...
    it: {
      ...
      pill10: "10 lingue",
      navPricing: "Prezzi",
      pricingKicker: "Offerta visitatori",
      pricingTeaser: "Licenza 7 giorni, accesso senza limiti",
      pricingTitle: "Licenza 7 giorni — accesso completo",
      pricingSubtitle: "Goditi tutte le funzioni di CityLoopQuest per 7 giorni, senza restrizioni.",
      pricingPeriod: "valida 7 giorni",
      pricingUnlimited: "Accesso senza restrizioni",
      pricingFeature1: "Tutti i percorsi della città",
      pricingFeature2: "Guida GPS, quiz, cultura e contenuti audio",
      pricingFeature3: "10 lingue incluse",
      pricingNote: "Acquisto e attivazione nell’app della città scelta (sezione Avvia l’app).",
      pricingCta: "Scegli una città",
...
shotCaption10: "Dialetto locale",
    ...
    es: {
      ...
      pill10: "10 idiomas",
      navPricing: "Precios",
      pricingKicker: "Oferta visitante",
      pricingTeaser: "Licencia 7 días, acceso sin restricciones",
      pricingTitle: "Licencia 7 días — acceso completo",
      pricingSubtitle: "Disfruta de todas las funciones de CityLoopQuest durante 7 días, sin restricciones.",
      pricingPeriod: "válida 7 días",
      pricingUnlimited: "Acceso sin restricciones",
      pricingFeature1: "Todos los recorridos de la ciudad",
      pricingFeature2: "Guía GPS, cuestionarios, cultura y audio",
      pricingFeature3: "10 idiomas incluidos",
      pricingNote: "Compra y activación en la app de la ciudad elegida (sección Lanzar la app).",
      pricingCta: "Elegir una ciudad",
...
shotCaption10: "Dialecto local",
    ...
    pl: {
      ...
      pill10: "10 języków",
      navPricing: "Cennik",
      pricingKicker: "Oferta dla gości",
      pricingTeaser: "Licencja na 7 dni, dostęp bez ograniczeń",
      pricingTitle: "Licencja 7 dni — pełny dostęp",
      pricingSubtitle: "Korzystaj ze wszystkich funkcji CityLoopQuest przez 7 dni bez ograniczeń.",
      pricingPeriod: "ważna 7 dni",
      pricingUnlimited: "Dostęp bez ograniczeń",
      pricingFeature1: "Wszystkie trasy w mieście",
      pricingFeature2: "Nawigacja GPS, quizy, kultura i audio",
      pricingFeature3: "10 języków w cenie",
      pricingNote: "Zakup i aktywacja w aplikacji wybranego miasta (sekcja Uruchom aplikację).",
      pricingCta: "Wybierz miasto",
...
shotCaption10: "Lokalna gwara",
    ...
    ar: {
      ...
      pill10: "10 لغات",
      navPricing: "الأسعار",
      pricingKicker: "عرض الزائر",
      pricingTeaser: "ترخيص 7 أيام، وصول بلا قيود",
      pricingTitle: "ترخيص 7 أيام — وصول كامل",
      pricingSubtitle: "استمتع بجميع ميزات CityLoopQuest لمدة 7 أيام دون أي قيود.",
      pricingPeriod: "صالح لمدة 7 أيام",
      pricingUnlimited: "وصول بلا قيود",
      pricingFeature1: "جميع مسارات المدينة",
      pricingFeature2: "توجيه GPS واختبارات وثقافة ومحتوى صوتي",
      pricingFeature3: "10 لغات مشمولة",
      pricingNote: "الشراء والتفعيل داخل تطبيق المدينة المختارة (قسم تشغيل التطبيق).",
      pricingCta: "اختر مدينة",
...
shotCaption10: "اللهجة المحلية",
    ...
    yue: {
      ...
      navPricing: "價格",
      pricingKicker: "遊客方案",
      pricingTeaser: "7 日授權，無限制使用",
      pricingTitle: "7 日授權 — 完整存取",
      pricingSubtitle: "7 天內盡享 CityLoopQuest 全部功能，沒有任何限制。",
      pricingPeriod: "有效期 7 天",
      pricingUnlimited: "無限制存取",
      pricingFeature1: "城市內所有路線",
      pricingFeature2: "GPS 導覽、測驗、文化與音訊內容",
      pricingFeature3: "包含 10 種語言",
      pricingNote: "在所選城市 App 內購買並啟用（「啟動 App」區塊）。",
      pricingCta: "選擇城市",
...
shotCaption10: "本地土話",
    ...
    ja: {
      ...
      navPricing: "料金",
      pricingKicker: "訪問者向け",
      pricingTeaser: "7日間ライセンス、制限なしアクセス",
      pricingTitle: "7日間ライセンス — フルアクセス",
      pricingSubtitle: "7日間、CityLoopQuestのすべての機能を制限なくお楽しみください。",
      pricingPeriod: "7日間有効",
      pricingUnlimited: "制限なしアクセス",
      pricingFeature1: "市内のすべてのルート",
      pricingFeature2: "GPS案内、クイズ、文化コンテンツと音声",
      pricingFeature3: "10言語対応",
      pricingNote: "選択した都市のアプリ内で購入・有効化（「アプリを起動」セクション）。",
      pricingCta: "都市を選ぶ",
